      ...
      <div className={dynamicClassName}>
        <div className="w-content m-center ">
          ...
          <div className="text-center m-[50px] leading-[3rem]">
            ...
            얼굴을 부비며 애정표현도 적극적으로 해줍니다. <br /> 스킨십도
            좋아하고 만져주면 아주 만족스러워 하고 좋아하지만 적정선을 넘으면
            싫어하기도 합니다. <br /> ​ 사람이 가지고 놀아주는 움직이는 장난감에
            진심을 다해 놀고 활발하고 에너지 넘치게 사냥놀이를 하는 것을
            즐깁니다.
          </div>
        </div>
      </div>
